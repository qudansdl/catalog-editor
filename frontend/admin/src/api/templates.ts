...
export default class ApiTemplate {
  static createTemplate = (name: string, description: string, categories: ICategoryData[]) => {
  ...
  static updateTemplate = (templateId: string, name: string, description: string, categories: ICategoryData[]) => {
